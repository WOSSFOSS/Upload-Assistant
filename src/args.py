...
class Args:
    ...
    def parse(self, argv: Sequence[str], meta: dict[str, Any]) -> tuple[dict[str, Any], CustomArgumentParser, list[str]]:
        ...
        parser.add_argument('-art', '--artist', nargs=1, required=False, help="Music artist override", type=str)
        parser.add_argument('-alb', '--album', nargs=1, required=False, help="Music album override", type=str)
        ...
        parser.add_argument('--book-number', '--book_number', nargs=1, required=False, help="Book/Audiobook series number", type=str, dest='book_number')
        ...
        parser.add_argument('-client_tag', '--client-tag', '--client_tag', dest='client_tag', nargs=1, required=False, help="Add to the selected torrent client with this tag")
        parser.add_argument('-client_link', '--client-link-path', '--client_link_path', dest='client_link_path', nargs=1, required=False, help="Override the linked_folder/link target path for this upload")
