...
class BT:
    ...
    async def get_description(self, meta: dict[str, Any]) -> str:
        ...
        # Signature
        desc_parts.append(f"[center][url=https://github.com/fr1day13/Upload-Assistant/tree/nightly]Upload realizado via {meta['ua_name']} {meta['current_version']}[/url][/center]")
