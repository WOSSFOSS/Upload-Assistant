config = {
    ...
    "TRACKERS": {
        ...
        # Available tracker: A4K, ACM, AITHER, ANT, AR, ASC, AZ, BHD, BHDTV, BJS, BLU, BT, CBR, CZ, DC, DP, DT, EMUW, FF, FL, FNP, FRIKI, GPW, HDB, HDS, HDT, HHD, HUNO, IHD, IS, ITT, LCD, LDU, LST, LT, LUME, MNS, MTV, NBL, OE, OTW, PHD, PT, PTER, PTP, PTS, PTT, R4E, RAS, RF, RTF, SAM, SHRI, SN, SP, SPD, STC, THR, TIK, TL, TLZ, TOS, TTG, TTR, TVC, ULCX, UTP, YOINK, YUS, ZNTH
    ...
    "SEARCH": {
        ...
        # Cache source/home filesystem scans between runs. Source scans are queue-specific;
        # home scans are tracker/profile-specific so stable home libraries can be reused
        # across different source queues.
        # Use upload.py --search --refresh-scan to ignore the cached scan once and write a fresh checkpoint.
        # Use upload.py --search --rescan to delete the current source/home scan checkpoints before scanning.
    ...
    "TORRENT_CLIENTS": {
        ...
        "qbittorrent": {
            ...
            # enable_search to True will automatically try and find a suitable hash to save having to rehash when creating torrents
            "enable_search": True,
            # Search mode for existing torrents:
